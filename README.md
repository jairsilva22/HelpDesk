...
📡 SignalR (comunicación en tiempo real / real-time communication)

🧰 Entity Framework Core

💌 SMTP para envío de correos / SMTP for email notifications

📲 Integración con WhatsApp API (pendiente)
...
🗂️ Asignación por departamento / Department-based assignment

🔄 Actualización en tiempo real (SignalR) / Real-time updates (SignalR)

📩 Notificaciones por email y WhatsApp / Email and WhatsApp notifications

📊 Dashboard de métricas y estados / Ticket metrics dashboard

🔒 Sistema de roles (Admin, Soporte, Usuario) / Role-based access
...
Interfaz amigable para móviles y escritorios.
